...
func (m *RecordMutation) SetHTTPMethod(rm record.HTTPMethod) {
	m.http_method = &rm
}

// HTTPMethod returns the value of the "http_method" field in the mutation.
func (m *RecordMutation) HTTPMethod() (r record.HTTPMethod, exists bool) {
	v := m.http_method
	if v == nil {
		return
	}
...
func (m *RecordMutation) OldHTTPMethod(ctx context.Context) (v record.HTTPMethod, err error) {
...
func (m *RecordMutation) SetIPAddress(s string) {
	m.ip_address = &s
}

// IPAddress returns the value of the "ip_address" field in the mutation.
func (m *RecordMutation) IPAddress() (r string, exists bool) {
	v := m.ip_address
	if v == nil {
		return
	}
...
// OldIPAddress returns the old "ip_address" field's value of the Record entity.
// If the Record object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RecordMutation) OldIPAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RecordMutation) ResetIPAddress() {
	m.ip_address = nil
}

// SetInstruction sets the "instruction" field.
func (m *RecordMutation) SetInstruction(s string) {
	m.instruction = &s
}

// Instruction returns the value of the "instruction" field in the mutation.
func (m *RecordMutation) Instruction() (r string, exists bool) {
	v := m.instruction
	if v == nil {
		return
	}
...
// OldInstruction returns the old "instruction" field's value of the Record entity.
// If the Record object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RecordMutation) OldInstruction(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RecordMutation) ResetInstruction() {
	m.instruction = nil
}

// SetTimestamp sets the "timestamp" field.
func (m *RecordMutation) SetTimestamp(t time.Time) {
	m.timestamp = &t
}

// Timestamp returns the value of the "timestamp" field in the mutation.
func (m *RecordMutation) Timestamp() (r time.Time, exists bool) {
	v := m.timestamp
	if v == nil {
		return
	}
...
// OldTimestamp returns the old "timestamp" field's value of the Record entity.
// If the Record object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RecordMutation) OldTimestamp(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RecordMutation) ResetTimestamp() {
	m.timestamp = nil
}
...
func (m *RecordMutation) Fields() []string {
	...
	if m.ip_address != nil {
		fields = append(fields, record.FieldIPAddress)
	}
	if m.instruction != nil {
		fields = append(fields, record.FieldInstruction)
	}
	if m.timestamp != nil {
		fields = append(fields, record.FieldTimestamp)
	}
	return fields
}
